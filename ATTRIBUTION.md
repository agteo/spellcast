...
Spellcast is based on [LiteRT.js-Mocap](https://github.com/andrisgauracs/LiteRT.js-Mocap) by Andris Gauracs. The initial application tree (`src/`, `public/characters/`, `public/models/`, Vite setup) was vendored from that project and will be extended with hand tracking, gestures, and effects.
